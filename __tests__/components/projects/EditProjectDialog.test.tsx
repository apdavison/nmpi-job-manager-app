...
function renderDialog(props: Partial<React.ComponentProps<typeof EditProjectDialog>>) {
  return render(<EditProjectDialog open={true} mode="edit" onClose={vi.fn()} {...props} />);
}
...
describe("EditProjectDialog", () => {
  ...
  test("pre-fills the title and abstract from the project", () => {
    ...
    expect((screen.getByLabelText(/Abstract/) as HTMLInputElement).value).toBe("My abstract");
  });
