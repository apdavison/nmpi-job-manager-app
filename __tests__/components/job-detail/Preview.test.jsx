...
describe("Preview", () => {
  test("renders an image for an image content type", async () => {
    render(
      <Preview open={true} url="http://x/img.png" content_type="image/png" onClose={vi.fn()} />
    );
  ...
  test("renders no content when closed", () => {
    render(
      <Preview open={false} url="http://x/img.png" content_type="image/png" onClose={vi.fn()} />
    );
  ...
  test("the close button calls onClose", () => {
    const onClose = vi.fn();
    render(
      <Preview open={true} url="http://x/img.png" content_type="image/png" onClose={onClose} />
    );
