...
const file = { id: "f1", name: "results.pkl", type: "file", path: "", size: 2048, mtime: 1700000000 };
const dir = { id: "d1", name: "subdir", type: "dir", path: "", size: "", mtime: 1700000000 };

describe("FileBrowser", () => {
  test("shows a progress indicator while loading", () => {
    render(<FileBrowser loading={true} path="" contents={[]} />);
